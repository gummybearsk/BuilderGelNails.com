...
const questions = [
  {
    ...
    link: '/guides/beginners-complete-guide-to-builder-gel',
  },
  {
  ...
  },
  {
    ...
    link: '/how-to/how-to-remove-builder-gel-safely',
  },
  {
  ...
  },
  {
    ...
    link: '/problems/builder-gel-lifting-causes-and-fixes',
  },
  {
  ...
  },
  {
    ...
    link: '/products/beetles-builder-gel-review',
  },
  {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/guides/beginners-complete-guide-to-builder-gel"
      ...
      <section className="py-16 bg-secondary-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Link
              href="/problems/builder-gel-lifting-causes-and-fixes"
